   ...
   <section class="wrapper site-min-height">
    <div>
      <div class="form-panel">
        <h4 align="center">Data Buku Rusak</h4>
         <form action="penerbit.php" method="get">
        <div class="col-xs-8 col-sm-4">
            <input type="text" name="cari" class="form-control col-xs-8" placeholder="Search...">
        </div>
        <a href='penerbit_tambah.php' class='btn btn-theme'>Daftar Buku Rusak &nbsp;<i class="fa fa-plus"></i></a>
    </form>
        <table class="table">
            <thead>
              <tr>
            ...
            $Data=mysqli_query($connect, "SELECT * from denda_buku_rusak where id_pinjam LIKE '%".$cari."%' OR Nama LIKE '%".$cari."%' OR judul_buku LIKE '%".$cari."%' ORDER BY id_pinjam ASC");
             $No=1;
